...
export function drillFormSections(current: V = {}): FieldSection[] {
  return [
    {
      title: 'זיהוי',
      fields: [
        {
          ...
          required: true,
          half: true,
          placeholder: 'בנדחה — יסודות',
          defaultValue: str(current, 'nameHe'),
          maxLength: 200,
        },
        {
          name: 'drillType',
          ...
          required: true,
          half: true,
          options: drillType.options(),
          defaultValue: str(current, 'drillType') ?? 'single_stroke',
        },
        {
          name: 'level',
          label: 'רמה',
        ...
        },
        {
          ...
          kind: 'text',
          half: true,
          placeholder: 'שיפור עקביות בנדחה',
          defaultValue: str(current, 'trainingGoal'),
        },
        {
          name: 'description',
          label: 'תיאור',
          kind: 'textarea',
          defaultValue: str(current, 'description'),
          maxLength: 2000,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          half: true,
          options: [
            { value: '1', label: 'שחקן אחד' },
            { value: '2', label: 'שני שחקנים' },
          ],
          defaultValue: str(current, 'playerCount') ?? '1',
        },
        {
          ...
          min: '5',
          max: '180',
          defaultValue: str(current, 'durationMinutes') ?? '30',
        },
        {
          name: 'shotCount',
          label: 'מספר מכות',
          ...
          dir: 'ltr',
          min: '1',
          // ⚠ ללא step: min יחד עם step יוצרים סריג ערכים חוקיים.
          // min=1 עם step=10 פוסל 200 ומציג הודעה מבלבלת מהדפדפן.
          defaultValue: str(current, 'shotCount'),
        },
        {
          name: 'sequence',
          label: 'רצף',
          ...
          required: true,
          half: true,
          options: shotSequence.options(),
          defaultValue: str(current, 'sequence') ?? 'fixed',
        },
      ],
    },
    {
      title: 'פרמטרי המכונה',
      description: 'הטווחים תואמים ליכולת PT-9001 בפועל. ערך מחוץ לטווח יידחה.',
      fields: [
        {
          name: 'speedKmh',
          label: 'מהירות (קמ״ש)',
          ...
          min: '20',
          max: '200',
          hint: 'נדרש כיול כדי לתרגם לערך המכונה.',
          defaultValue: str(current, 'speedKmh'),
        },
        {
          name: 'frequencyPerMinute',
          label: 'תדירות (כדורים לדקה)',
          kind: 'number',
          half: true,
          dir: 'ltr',
          min: '7',
          max: '33',
          hint: 'יכולת המכונה: 7–33.',
          defaultValue: str(current, 'frequencyPerMinute'),
        },
        {
          name: 'spinLevel',
          label: 'סיבוב',
          ...
          min: '-30',
          max: '30',
          hint: 'חיובי טופספין, שלילי בקספין.',
          defaultValue: str(current, 'spinLevel'),
        },
        {
          name: 'heightLevel',
          label: 'גובה (1–10)',
          ...
          min: '1',
          max: '10',
          defaultValue: str(current, 'heightLevel'),
        },
        {
          name: 'depthLevel',
          label: 'עומק (1–10)',
          ...
          min: '1',
          max: '10',
          defaultValue: str(current, 'depthLevel'),
        },
        {
          name: 'angleDegrees',
          label: 'זווית (מעלות)',
          ...
          min: '-45',
          max: '45',
          defaultValue: str(current, 'angleDegrees'),
        },
        {
          name: 'safetyInstructions',
          label: 'הוראות בטיחות',
          kind: 'textarea',
          defaultValue: str(current, 'safetyInstructions'),
          maxLength: 1000,
        },
      ],
    },
